...
import { MapPin, Plane, Building2, Home, TrendingUp, Shield, ArrowRight, Star, Zap, Crown } from "lucide-react"
  ...
  const corridors = [
    {
      ...
      features: ["Metro Connectivity", "IT Hubs", "Educational Institutes", "Healthcare Facilities"],
    ...
    },
    {
      ...
      features: ["Jewar Airport", "Industrial Corridor", "Logistics Hub", "Future Growth"],
    ...
    },
    {
      ...
      features: ["Family Communities", "Schools & Colleges", "Hospitals", "Shopping Centers"],
    ...
    },
    {
      ...
      description: "A portfolio of hand-vetted, high-ticket properties—from sprawling independent villas to secured gated plots—for the discerning client who values absolute privacy and generational wealth.",
      icon: <Crown className="w-6 h-6" />,
      features: ["Privacy & Security", "Legacy Properties", "Premium Amenities", "Exclusive Access"],
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted max-w-3xl mx-auto leading-relaxed">
            India's Growth Corridors - Strategic locations where we unlock premium real estate opportunities
          </p>
        </motion.div>
        ...
        {/* Content Layout */}
        <div className={`${activeCorridor === 'luxury' ? 'flex justify-center' : 'grid lg:grid-cols-2 gap-12 items-start'}`}>
            ...
            {activeCorridor === 'ghaziabad' ? (
              ...
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted text-sm">Select a location to view the map</p>
                </div>
              </div>
            )}
            </motion.div>
          ...
          <motion.div 
            className={`space-y-6 h-[387px] flex flex-col justify-end ${activeCorridor === 'luxury' ? 'max-w-2xl' : ''}`}
            key={`content-${activeCorridor}`}
            initial={activeCorridor === 'luxury' ? { opacity: 1, x: 0 } : { opacity: 0, x: 100 }}
            animate={{ opacity: 1, x: 0 }}
