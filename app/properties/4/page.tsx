...
export default function PropertyPage() {
  ...
  const property = {
    ...
    // Location Advantage
    connectivity: [
      "Just 5 minutes from Central Noida",
      "Direct access to Noida-Greater Noida Expressway & Delhi NCR",
      "Upcoming metro station at your doorstep",
      "Smooth road connectivity to Delhi, NH-24, and Yamuna Expressway"
    ],
    landmarks: [
      "Yatharth, Fortis, Kailash Hospitals",
      "DPS, Lotus Valley, Ryan International",
      "Amity University",
      "Gaur City Mall",
      "DLF Mall of India",
    ...
    amenities: {
      ...
      unique: [
        "6 Iconic Towers spread across 8 acres",
        "70% open green spaces",
        "Contemporary architecture with premium finishes",
        "Smart space planning and natural ventilation"
      ]
    },

    // Specifications
    specifications: {
      flooring: "High-end fittings and fixtures for a refined living experience",
    ...
    developerInfo: {
      experience: "RG Group brings a legacy of trust and excellence in real estate",
      projectsDelivered: "Known for delivering landmark projects with timely execution",
      notableProjects: [
    ...
    pricing: {
      ...
      startingPrice: "Launch Price Available",
      paymentPlan: "Flexible payment plans available",
      offers: "Limited inventory with pre-launch benefits - Expression of Interest (EOI): ₹15 Lakhs only"
    },
