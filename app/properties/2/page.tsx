...
export default function PropertyPage() {
  ...
  const property = {
    ...
    connectivity: [
      ...
      "Delhi - 30 minutes", 
      "Jewar Airport - 1 hour",
      "Yamuna Expressway - Fast accessibility"
    ],
    landmarks: [
      "Aster Public School",
      ...
      "KD S G Hospital",
      "Yatharth Hospital",
      "Motherland Hospital & IVF Center",
      "Google Data Center / IT Hub",
      "Gaur City Mall"
    ],
    ...
    amenities: {
      ...
      recreation: [
        ...
        "Car Washing Area & Driver Waiting Room",
        "Clubhouse",
        "Banquet Hall", 
        "Amphitheatre",
        "Kids Zone & Play Area",
    ...
    // Specifications
    specifications: {
      flooring: "Vitrified tiles (living & bedrooms), ceramic tiles (bathrooms & balconies)",
      kitchen: "Semi-modular granite counter, branded fittings",
      bathrooms: "Designer tiles & fittings with geyser provisions",
      electricals: "Smart-home enabled controls, split AC provision",
    ...
    developerInfo: {
      ...
      notableProjects: [
        "Spring Elmas - Sector 12 (Current Project)"
      ],
      awards: [
