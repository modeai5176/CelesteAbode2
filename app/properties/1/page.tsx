...
export default function PropertyPage() {
  ...
  const property = {
    ...
    structureQuality:
      "Earthquake-resistant RCC structure with premium quality materials",
        ...
        <section className="relative h-[70vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-end justify-start pb-16 pl-12">
            <div className="text-center text-white max-w-4xl mx-auto px-4">
              <Badge
                className="mb-4 bg-[#CBB27A] text-white text-lg px-6 py-3 rounded-full border-2 border-[#CBB27A]/30"
                style={{
                  boxShadow:
                    "0 0 15px rgba(203, 178, 122, 0.8), 0 0 30px rgba(203, 178, 122, 0.4)",
                }}
              >
                {property.status}
              </Badge>
              <h1 className="text-5xl md:text-6xl font-bold mb-4">
                <span className="text-white">IVORY</span>{" "}
                <span className="text-[#CBB27A]">COUNTY</span>
              </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="font-semibold">
                  {property.unitTypes.length} Types
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-2">
                  ...
                  <CardContent className="p-6">
                    <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {property.developerInfo.projects.map(
                            (project, index) => (
                              <li
                                key={index}
                                className="flex items-center gap-2"
