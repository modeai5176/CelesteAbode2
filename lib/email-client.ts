// Client-side email utilities (no server dependencies)
...
/**
 * Helper function to create email content for segmented entry (client-side)
 */
...
/**
 * Client-side function for segmented entry form (calls API)
 */
